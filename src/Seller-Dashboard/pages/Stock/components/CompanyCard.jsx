...
const CompanyCard = ({
    ...
    const displayAllProducts = () => {
        navigate(`/seller/stock?collectionID=${$id}`);
    ...
    return (
        ...
        <div className={styles.buttons}>
            <SecondaryButton onClickHandler={displayAllProducts}>
            All Products
            </SecondaryButton>
...
const styles = {
    companyCard:
        "relative group cursor-pointer p-3 rounded-xl border dark:border-gray-800 border-pink-200 hover:border-pink-300 h-[200px] w-[400px] flex flex-col gap-5 justify-between dark:bg-[rgb(20,20,31)] dark:hover:bg-gray-800 hover:bg-pink-50 bg-white",
    ...
    companyDesc:
        "dark:text-gray-500 text-gray-500 font-semibold text-xs line-clamp-3",
    DeleteIcon:
        "absolute top-1 right-1 hidden group-hover:flex transition-all duration-1000 linear text-xl cursor-pointer text-red-600 hover:text-red-500 hover:scale-125",
